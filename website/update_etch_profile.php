...
";
    ...
    echo "Original length: " . strlen($sourceContent) . " characters\n";
    echo "Cleaned length: " . strlen($cleanContent) . " characters\n";
    
    // Update the database
    $updateStmt = $pdo->prepare("UPDATE qa_responses SET response = ? WHERE id = 10728");
    $updateStmt->execute([$cleanContent]);
    
    echo "Successfully updated etch profile modeling content (ID 10728)!\n";
    echo "Removed LaTeX formatting and kept full content\n";
